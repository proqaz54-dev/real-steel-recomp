...
enum class Op {
    ...
    FCMPU, FMADD, FMSUB, FNMADD, FNMSUB, FMULADD, MFFS, MTFSF,
    PS_ADD, PS_SUB, PS_MUL, PS_DIV, PS_ABS, PS_NEG, PS_MR, PS_RSQRT, PS_MADD,
    PSQ_LX, PSQ_STX, PSQ_L, PSQ_ST,
    // condition register / special
    MFLR, MTLR, MFCTR, MTCTR, MFSPR, MTSPR,
    CMPW, CMPLW, CMPI, CMPLI, CMPB,
    MFCR, MTCRF, MCRF, CRAND, CROR, CRXOR, CRNAND, CREQV, CRANDC, CRNOR, CRORC,
